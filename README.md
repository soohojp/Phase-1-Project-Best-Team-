...
Then, we formulated a list containing all of those values. The list of unique genres from above and the sum of profits of all films were used to formulate a bar graph.
...
On all of the metrics, War, Western, Sport, and Documentary genres are the least likely to yield high profits.
